...
「このシステム、誰も全体像を把握してないんだよね」——普段チーム開発をしているとこういう状況一度は経験したことあると思います。機能は動いている。テストもある。でも半年後に見返すと、なぜこの設計にしたのか、どこから読めばいいのか、すぐには思い出せない。

メンバーの入れ替わりがあるチームならもっと深刻です。新しいメンバーが加わるたびに「コードを読んで把握してください」になる。ドキュメントを書こうとはするけど、機能開発の忙しさの中で後回しになる。書くコストが構造的に高すぎるのが原因だと感じていました。
